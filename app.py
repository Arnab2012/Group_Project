...
def prediction(real,fake):
    ...
    temp.markdown('<div style="font-weight: bold; font-size: 10px;">Calculating....</div>', unsafe_allow_html=True)
    ...
    html += f'<div style="font-weight: bold; font-size: 10px;">Real - {real}%</div>'
    html += f'<div style="font-weight: bold; font-size: 10px;">Fake - {fake}%</div>'
    html += f'</div>'
