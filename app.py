...
def prediction(real,fake):
    ...
    temp.markdown('<div style="font-weight: bold; font-size: 50px;">Calculating....</div>', unsafe_allow_html=True)
    ...
    html += f'<div style="font-weight: bold; font-size: 50px;">Real - {real}%</div>'
    html += f'<div style="font-weight: bold; font-size: 50px;">Fake - {fake}%</div>'
    html += f'</div>'
